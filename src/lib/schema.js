...
const MISSING_RE = /fixed_costs|day_types|daily_logs|bucket_settings|deepdive_|grocery_|main_monthly_budget|budget_mode|expenses\.bucket|column .*bucket|does not exist|schema cache/i
